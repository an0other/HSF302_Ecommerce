...
public class ProductsController {
    ...
    public String products(
        ...
        Page<HomeProductDTO> productPage = productService.getProducts(categoryId, brandId, kw, sort, minRating, page);

        if (productPage.getTotalPages() > 0 && page >= productPage.getTotalPages()) {
            page = productPage.getTotalPages() - 1;
            productPage = productService.getProducts(categoryId, brandId, kw, sort, minRating, page);
        }
